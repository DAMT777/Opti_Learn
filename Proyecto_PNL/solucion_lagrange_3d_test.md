...
## 📊 VISUALIZACIONES GEOMÉTRICAS DEL MÉTODO DE LAGRANGE

### 📈 Visualización 2D - Curvas de Nivel

**Interpretación gráfica en el plano:**
...
<img src="/static/tmp/lagrange_2d_2355.png" alt="Visualización 2D de Lagrange" style="max-width: 100%; width: 600px; height: auto; display: block; margin: 20px auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" />

💡 **Observación clave:** El punto óptimo se encuentra donde una curva de nivel
de la función objetivo es **tangente** a la restricción.

### 🌐 Visualización 3D - Superficie

**Interpretación gráfica en el espacio:**

El siguiente gráfico tridimensional muestra:
- **Superficie de la función objetivo** f(x, y) en tonos viridis
- **Curva de restricción** g(x, y) = 0 proyectada sobre la superficie (rojo)
- **Punto óptimo** en verde, con proyección vertical al plano base

<img src="/static\tmp\lagrange_3d_2355.png" alt="Visualización 3D de Lagrange" style="max-width: 100%; width: 700px; height: auto; display: block; margin: 20px auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" />

💡 **Perspectiva 3D:** Esta vista permite apreciar cómo el punto óptimo se encuentra
sobre la superficie de la función objetivo, restringido a moverse únicamente a lo largo
de la curva roja (restricción). El óptimo ocurre donde el gradiente de f es perpendicular
a la curva de restricción.
