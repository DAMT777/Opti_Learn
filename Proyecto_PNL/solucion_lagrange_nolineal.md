...
$$\mathcal{L}(x, y, \lambda) = - \lambda \left(x + y - 2\right) + x^{2} + x y + 3 x + y^{2}$$

**Componentes:**

- **Función objetivo:** $f(x, y)$
- **Penalización restricción 1:** $-(\lambda \left(x + y - 2\right))$
...
$$\frac{\partial \mathcal{L}}{\partial x} = - \lambda + 2 x + y + 3 = 0$$

$$\frac{\partial \mathcal{L}}{\partial y} = - \lambda + x + 2 y = 0$$
...
$$H_f = \left[\begin{matrix}2 & 1\\1 & 2\end{matrix}\right]$$
...
**Punto óptimo:** $(x^* = -0.5000, y^* = 2.5000)$
