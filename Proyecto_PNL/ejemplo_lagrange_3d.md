...
<img src="/static/tmp/lagrange_2d_1019.png" alt="Visualización 2D de Lagrange" style="max-width: 100%; width: 600px; height: auto; display: block; margin: 20px auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" />
...
<img src="/static\tmp\lagrange_3d_1019.png" alt="Visualización 3D de Lagrange" style="max-width: 100%; width: 700px; height: auto; display: block; margin: 20px auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" />
