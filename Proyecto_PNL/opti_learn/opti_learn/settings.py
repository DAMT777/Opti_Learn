...
# Orígenes de confianza para CSRF (necesario para formularios/WS cuando se usa host/puerto local)
...
INSTALLED_APPS = [
    'channels',  # Debe ir antes de staticfiles para que runserver use ASGI
