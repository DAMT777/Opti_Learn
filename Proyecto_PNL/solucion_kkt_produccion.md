...
$$\mathcal{L} = \lambda_{0} \left(2 x + y - 100\right) + \lambda_{1} \left(x + 2 y - 80\right) - \lambda_{2} x - \lambda_{3} y - 40 x - 30 y$$
...
$$\frac{\partial \mathcal{L}}{\partial x} = 2 \lambda_{0} + \lambda_{1} - \lambda_{2} - 40 = 0$$

$$\frac{\partial \mathcal{L}}{\partial y} = \lambda_{0} + 2 \lambda_{1} - \lambda_{3} - 30 = 0$$
...
**Caso 1:**
  - Inactivas: restricciones 1, 2, 3, 4

**Caso 2:**
  - Activas: restricciones 4
  - Inactivas: restricciones 1, 2, 3

**Caso 3:**
  - Activas: restricciones 3
  - Inactivas: restricciones 1, 2, 4

**Caso 4:**
  - Activas: restricciones 3, 4
  - Inactivas: restricciones 1, 2

**Caso 5:**
  - Activas: restricciones 2
  - Inactivas: restricciones 1, 3, 4

**Caso 6:**
  - Activas: restricciones 2, 4
  - Inactivas: restricciones 1, 3

**Caso 7:**
  - Activas: restricciones 2, 3
  - Inactivas: restricciones 1, 4

**Caso 8:**
  - Activas: restricciones 2, 3, 4
  - Inactivas: restricciones 1

**Caso 9:**
  - Activas: restricciones 1
  - Inactivas: restricciones 2, 3, 4

**Caso 10:**
  - Activas: restricciones 1, 4
...
- $\lambda_{0} = 50/3$ (activa)
- $\lambda_{1} = 20/3$ (activa)
...
- $\lambda_{0} = 50/3$: Sensibilidad del objetivo ante cambios en esta restricción
- $\lambda_{1} = 20/3$: Sensibilidad del objetivo ante cambios en esta restricción
